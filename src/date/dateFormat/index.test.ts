...
describe('dateFormat 测试', () => {
  {
    let date = new Date();
    const { year, month, day, hour, minute, second }: deconstructDateInterface = deconstructDate(date);
  ...
  {
    let date = new Date('2020/9/18 12:5:10');
    const { year, month, day, hour, minute, second }: deconstructDateInterface = deconstructDate(date);
  ...
  {
    let date = new Date('2020/1/1 23:00:05');
    const { year, month, day, hour, minute, second }: deconstructDateInterface = deconstructDate(date);
  ...
  {
    let date = new Date('2020/12/28 12:35:10:120');
    const { year, month, day, hour, minute, second, milliSecond }: deconstructDateInterface = deconstructDate(date);
